require "acts_as_taggable_on_mongoid/engine"
...
WARNING
    ...
    def self.apply_binary_collation(bincoll)
      if Utils.using_mysql?
        ...
        begin
          ActiveRecord::Migration.execute("ALTER TABLE #{Tag.collection_name} MODIFY name varchar(255) CHARACTER SET utf8 COLLATE #{coll};")
        rescue Exception => e
