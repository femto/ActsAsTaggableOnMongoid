module ActsAsTaggableOnMongoid::Taggable
  module Ownership
    def self.included(base)
      base.extend ActsAsTaggableOnMongoid::Taggable::Ownership::ClassMethods
    ...
    def owner_tag_list_on(owner, context)
      ...
      cache[owner] ||= ActsAsTaggableOnMongoid::TagList.new(*owner_tags_on(owner, context).map(&:name))
    end
    ...
    def save_owned_tags
      tagging_contexts.each do |context|
        cached_owned_tag_list_on(context).each do |owner, tag_list|
          ...
          ActsAsTaggableOnMongoid::Tagging.where(taggable_id: id, taggable_type: self.class.base_class.to_s,
