...
module ActsAsTaggableOnMongoid::Taggable
  module Core
    ...
    def self.included(base)
      base.extend ActsAsTaggableOnMongoid::Taggable::Core::ClassMethods
    ...
    module ClassMethods
      ...
      def tagged_with(tags, options = {})
        ...
        ::ActsAsTaggableOnMongoid::Taggable::TaggedWithQuery.build(self, ActsAsTaggableOnMongoid::Tag, ActsAsTaggableOnMongoid::Tagging, tag_list, options)
      end
    ...
    def all_tags_list_on(context)
      ...
      instance_variable_set(variable_name, ActsAsTaggableOnMongoid::TagList.new(all_tags_on(context).map(&:name)).freeze)
    end
    ...
    def load_tags(tag_list)
      ActsAsTaggableOnMongoid::Tag.find_or_create_all_with_like_by_name(tag_list)
    end
    ...
    ##
    # Override this hook if you wish to subclass {ActsAsTaggableOnMongoid::Tag} --
